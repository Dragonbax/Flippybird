...
void egc_init_plug (void)
{
	...
	egc_system_name = "flippybird";
	egc_system_location = "C:\\Users\\Felix-Olivier\\Desktop\\flippybird\\flippybirdproject\\EIFGENs\\flippybird\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1453854678;
