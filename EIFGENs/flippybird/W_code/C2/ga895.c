...
extern void F895_10231(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg2, 894, l_feature_name, 2, eif_new_type(918, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7230, dtype)) = (EIF_INTEGER_32) arg5;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 7231, 0xF8000396, 0); /* pixel_format */
	RTAR(Current, arg2);
...
void F895_10231 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 894, Current, 0, 10230);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("exists", Current);
	tb1 = '\01';
