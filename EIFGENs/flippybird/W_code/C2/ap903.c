...
extern void F903_9400(EIF_REFERENCE);
extern void F903_9401(EIF_REFERENCE);
...
/* {APPLICATION}.make */
void F903_9400 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 902, Current, 0, 0, 15103);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7271, dtype))(Current);
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7224, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
...
void F903_9401 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 902, Current, 6, 0, 15104);
	RTSA(Dtype(Current));
	RTSC;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(7266, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
