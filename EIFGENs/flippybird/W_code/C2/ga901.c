...
extern EIF_TYPED_VALUE F901_9386(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F901_9391(EIF_REFERENCE);
extern EIF_TYPED_VALUE F901_9392(EIF_REFERENCE);
extern EIF_TYPED_VALUE F901_9393(EIF_REFERENCE);
extern EIF_TYPED_VALUE F901_9394(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F901_9395(EIF_REFERENCE);
extern void F901_10234(EIF_REFERENCE, int);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 1, 15090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7255, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(7255, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F901_9385 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(7255,Dtype(Current)));
	return r;
}


/* {GAME_DISPLAY}.name */
EIF_TYPED_VALUE F901_9386 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 2, 0, 15092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7255, dtype));
	ui4_1 = ti4_1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 15093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 15094);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 15095);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 15096);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(900, Current, 15096);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("displays_bound_is_video_enabled", EX_PRE);
...
/* {GAME_DISPLAY}.bound */
EIF_TYPED_VALUE F901_9391 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 2, 0, 15097);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(900, Current, 15097);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("displays_bound_is_video_enabled", EX_PRE);
...
EIF_TYPED_VALUE F901_9392 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 2, 0, 15098);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 2, 0, 15086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F901_9394 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 2, 1, 15087);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 4, 0, 15088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F901_10234 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 900, Current, 0, 10233);
	RTSA(dtype);
	RTME(dtype, 0);
