...
#define ub4 ub4x.it_b
	...
	RTEAA(l_feature_name, 905, Current, 0, 0, 15183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ur1 = RTCCL(tr2);
	tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7344, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(7308, dtype));
	ub1 = tb1;
	tb2 = *(EIF_BOOLEAN *)(Current + RTWA(7312, dtype));
	ub2 = tb2;
	tb3 = *(EIF_BOOLEAN *)(Current + RTWA(7320, dtype));
	ub3 = tb3;
	tb4 = *(EIF_BOOLEAN *)(Current + RTWA(7324, dtype));
	ub4 = tb4;
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7332, dtype));
	ui4_1 = ti4_1;
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(7334, dtype));
	ui4_2 = ti4_2;
	ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(7338, dtype));
	ui4_3 = ti4_3;
	ti4_4 = *(EIF_INTEGER_32 *)(Current + RTWA(7340, dtype));
	ui4_4 = ti4_4;
