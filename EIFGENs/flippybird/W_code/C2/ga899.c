...
extern EIF_TYPED_VALUE F899_9376(EIF_REFERENCE);
extern EIF_TYPED_VALUE F899_9377(EIF_REFERENCE);
...
RTOID (F899_9376)
EIF_TYPED_VALUE F899_9376 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 898, Current, 1, 0, 15078);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(898, Current, 15078);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
EIF_TYPED_VALUE F899_9377 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
