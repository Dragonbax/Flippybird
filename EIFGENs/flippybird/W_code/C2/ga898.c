...
extern void F898_10232(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 897, l_feature_name, 1, eif_new_type(918, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F898_10232 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 897, Current, 0, 10231);
	RTSA(dtype);
	RTME(dtype, 0);
