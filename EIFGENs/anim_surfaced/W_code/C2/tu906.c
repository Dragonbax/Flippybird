...
extern EIF_TYPED_VALUE F906_9423(EIF_REFERENCE);
extern void F906_9424(EIF_REFERENCE);
...
/* {TUYAUX}.distance_entre */
EIF_TYPED_VALUE F906_9423 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
/* {TUYAUX}.default_create */
void F906_9424 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 905, Current, 1, 0, 15126);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(905, Current, 15126);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000398, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(920, 0x01).id);
	tr2 = RTMS_EX_H("pipe_one_img.png",16,564362855);
	ur1 = tr2;
